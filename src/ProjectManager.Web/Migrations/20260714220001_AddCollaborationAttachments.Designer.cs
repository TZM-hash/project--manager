...
namespace ProjectManager.Web.Migrations
{
    ...
    partial class AddCollaborationAttachments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectManager.Web.Models.MaintenanceOrder", b =>
                {
                    ...
                    b.Property<string>("OnSiteHardwareFrequency")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<string>("OnSiteSoftwareFrequency")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
            ...
            modelBuilder.Entity("ProjectManager.Web.Models.OperationJob", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("InputRelativePath")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
            ...
            modelBuilder.Entity("ProjectManager.Web.Models.ProjectCollaborationAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ProjectCollaborationRecordId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ProjectCollaborationRecordId", "CreatedAt");

                    b.ToTable("ProjectCollaborationAttachments");
                });

            modelBuilder.Entity("ProjectManager.Web.Models.ProjectCollaborationRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ProjectCollaborationRecords");
                });
            ...
            modelBuilder.Entity("ProjectManager.Web.Models.OperationJob", b =>
                {
                    b.HasOne("ProjectManager.Web.Models.ApplicationUser", "RequestedByUser")
                        .WithMany("OperationJobs")
            ...
            modelBuilder.Entity("ProjectManager.Web.Models.ProjectCollaborationAttachment", b =>
                {
                    b.HasOne("ProjectManager.Web.Models.ApplicationUser", "CreatedByUser")
                        .WithMany("CollaborationAttachments")
                        .HasForeignKey("CreatedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ProjectManager.Web.Models.ProjectCollaborationRecord", "Record")
                        .WithMany("Attachments")
                        .HasForeignKey("ProjectCollaborationRecordId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ProjectManager.Web.Models.ProjectGanttTask", b =>
                {
                    b.HasOne("ProjectManager.Web.Models.ApplicationUser", "OwnerUser")
                        .WithMany()
                        .HasForeignKey("OwnerUserId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("ProjectManager.Web.Models.ProjectGanttTask", "PredecessorTask")
            ...
            modelBuilder.Entity("ProjectManager.Web.Models.ApplicationUser", b =>
                {
                    b.Navigation("CollaborationAttachments");

                    b.Navigation("CollaborationRecords");

                    b.Navigation("OperationJobs");
